         ...
         console.log("looking for userid")
          ...
          User.findOne({ 'googleid' : profile.id }, function(err, user) {
              ...
              if (user) {
                ...
                if(!googlepictureurl) {
                  user.googlepictureurl = 'http://picasaweb.google.com/data/entry/api/user/' + profile.id + '?alt=json';
                } if(!user.readBooks) {
                  user.readBooks = [];
                  ...
                  user.friends = [];
                } if (!user.mediaServices) {
                  user.mediaServices = [];
                } if (!user.genres) {
                  user.genres = [];
                } if(!user.mediaPreferences) {
                  user.mediaPreferences = [];
                }
              } else {
